...
<body>
    ...
    <div class = "d-flex justify-content-center align-items-center __centered">
        <div class="p-3 rounded shadow __regist-form">
            ...
            <p>
                Has sido invitado a la ceremonia de distinciones al mérito Politécnico del año 2024, con el fin de otorgar
                 premios a la comunidad por ser personas sobresalientes y competentes que enorgullecen a la comunidad. <br> <br>
                 La presente invitación es para otorgarte un reconocimiento de <b> <?=$_SESSION['user_prize']?> </b>. <br>
                *iNSERTAR demás datos* <br> <br>
            </p>
	 ...
	 <div class="d-flex justify-content-center align-items-center flex-column" style="min-height: 100vh;">
        ...
        <h1 class="text-center display-4" style="margin-top: -60px;font-size: 2rem"> Hello <?=$_SESSION['user_name']?></h1>
        <a href="logout.php" class="btn btn-warning">LOGOUT</a>
